...
- **Modern Emacs** — an Emacs 31 configuration (default build: Emacs 31.1 via emacs-overlay; floor: `emacs "30.1"`), with native compilation, tree-sitter modes, lexical binding throughout, and `use-package` built-in.
